...
1. **`public/index.js`** (Kapcsolódó HTML: `public/index.html`)
...
2. **`public/csoportok.js`** (Kapcsolódó HTML: `public/csoportok.html`)
...
3. **`public/jelentkezok.js`** (Kapcsolódó HTML: `public/jelentkezok.html`)
...
4. **`public/modosit.js`** (Kapcsolódó HTML: `public/modosit.html`)
...
5. **`public/jmodosit.js`** (Kapcsolódó HTML: `public/jmodosit.html`)
